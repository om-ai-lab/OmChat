...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default="s122.json", help="The path to model output file.")
    parser.add_argument('--answer_path', type=str, default="omchat/eval_scripts/mmmu/answer_dict_val.json", help="Answer file path.")
