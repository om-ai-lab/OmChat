...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        qs = qs + "\nAnswer one of the options listed."
        ...
        outputs.append(
            {
                "image": idx,
                "prompt": cur_prompt,
                "answer": answers.rsplit("</s>", 1)[0],
                "annotation": anno[0],
                "model_id": model_name,
            }
        )
    print("====================== Eval AI2D ======================")
    print(f"Evaluating ai2diagram_test ...")
    json.dump(outputs, open(answers_file, "w"), ensure_ascii=False, indent=2)

    print("accuracy: {} %".format(evaluate_exact_match_accuracy(outputs)))
