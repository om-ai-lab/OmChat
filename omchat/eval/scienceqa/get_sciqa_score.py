...
if __name__ == "__main__":
    ...
    ###### IMG ######
    print(multimodal_correct, multimodal_incorrect, multimodal_total)
    if multimodal_total != 0:
        ...
        print(
            f"Total: {total}, Correct: {correct}, Accuracy: {correct / total * 100:.2f}%, IMG-Accuracy: 0.0%"
        )
